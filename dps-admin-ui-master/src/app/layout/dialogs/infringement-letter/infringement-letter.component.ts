...
@Component({
  selector: 'fury-infringement-letter',
  templateUrl: './infringement-letter.component.html',
  styleUrls: ['./infringement-letter.component.scss']
})
export class InfringementLetterComponent implements OnInit {
  ...
  constructor(
    private dialogRef: MatDialogRef<InfringementLetterComponent>,
