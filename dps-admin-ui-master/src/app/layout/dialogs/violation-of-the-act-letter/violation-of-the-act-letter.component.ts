...
@Component({
  selector: 'fury-violation-of-the-act-letter',
  templateUrl: './violation-of-the-act-letter.component.html',
  styleUrls: ['./violation-of-the-act-letter.component.scss']
})
export class ViolationOfTheActLetterComponent implements OnInit {
  ...
  constructor(
    private dialogRef: MatDialogRef<ViolationOfTheActLetterComponent>,
  ...
  ngOnInit(): void {
    ...
    //this.CreatedAt = this.pipe.transform(new Date(this.parent_data.CreatedAt), 'dd/MM/yyy');
